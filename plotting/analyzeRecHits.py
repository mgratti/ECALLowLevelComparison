...
def makeNoiseVsEtaPlot(graphs, gr1='EEP', name1='EE+', gr2='EEM', name2='EE-', suffix=''):
  ...
  #c1.SetLogy()
  c1.SaveAs('plots/NoiseVsEta_{}{}.pdf'.format(gr1[:2],suffix))
  c1.SaveAs('plots/NoiseVsEta_{}{}.png'.format(gr1[:2],suffix))
  c1.SaveAs('plots/NoiseVsEta_{}{}.C'.format(gr1[:2],suffix))
  c1.SaveAs('plots/NoiseVsEta_{}{}.root'.format(gr1[:2],suffix))
...
if __name__ == "__main__":
  ...
  makeNoiseVsEtaPlot(graphs, gr1='EBP', name1='EB+', gr2='EBM', name2='EB-', suffix='_energy')
  makeNoiseVsEtaPlot(graphs, gr1='EEP', name1='EE+', gr2='EEM', name2='EE-', suffix='_energy')
  ...
  makeNoiseVsEtaPlot(graphs, gr1='EBP', name1='EB+', gr2='EBM', name2='EB-', suffix='_et')
  makeNoiseVsEtaPlot(graphs, gr1='EEP', name1='EE+', gr2='EEM', name2='EE-', suffix='_et')
